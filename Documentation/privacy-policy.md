...
ELO DevTools does not collect, store, or transmit any personal data.  
This extension runs entirely inside the user's browser. All functionality is executed locally.  
